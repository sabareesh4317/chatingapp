  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="relative flex-1 hidden w-0 lg:block">
        <div className="absolute inset-0 object-cover w-full h-full bg-gradient-to-r from-secondary-500 to-accent-500"></div>
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-white">
          <h1 className="text-4xl font-bold">Join Realtym Chat</h1>
          <p className="mt-4 text-xl">Create an account and start chatting with friends and colleagues.</p>
        </div>
      </div>
    </div>
  );
